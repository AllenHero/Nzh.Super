...
namespace Nzh.Super.Models
{
    ...
    {
        public static HtmlString ActionCheckBox(this IHtmlHelper helper, dynamic _list = null, dynamic _alist = null)
        {
        ...
        public static HtmlString DisplayStatusHtml(this IHtmlHelper helper, bool? value)
        {
            var msg = value.Value ? "启用" : "停用";
            return new HtmlString(string.Format("<span>{0}</span>", msg));
        }

        public static HtmlString StatusRadioHtml(this IHtmlHelper helper, bool? value)
        {
            var msg = value.Value ? "启用" : "停用";
...
<div class=""layui-unselect layui-form-radio""><i class=""layui-anim layui-icon""></i><div>停用</div></div>", enabledStatus, disabledStatus);
        ...
        public static HtmlString StatusSelectHtml(this IHtmlHelper helper, string defaultTxt = "")
        {
        ...
        public static HtmlString GanderRadioHtml(this IHtmlHelper helper, int defaultVal = 1)
        {
        ...
        public static HtmlString SearchBtnHtml(this IHtmlHelper helper, string txt = "搜索", string _class = "")
        {
        ...
        public static HtmlString ResetBtnHtml(this IHtmlHelper helper, string txt = "重置", string _class = " layui-btn-primary")
        {
